...
export function getFriendlySettingDescription(setting) {
  const descriptions = {
    ...
    "incentive.rules": "Controls product and service incentive rates, staff visibility, and payout approval safeguards.",
    "document.numbering": "Shows current document number formats. Backend generators are not connected to this setting yet.",
    "system.allow_branch_specific_settings": "Shows whether settings can be separated per branch. This is currently shown as view-only until the branch settings flow is fully connected.",
  }
