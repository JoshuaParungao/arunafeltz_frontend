...
import { getItemCategories, getItems, getUnits, updateItemById } from "../../features/items/items.api"
...
function ItemMobileCard({ canManagePrices, canViewCost, item, onEditPrices, onViewDetails }) {
  return (
...
function ItemsPage({ selectedBranch, user }) {
  ...
  const loadFilterOptions = async () => {
    try {
      ...
      if (selectedBranch?.id) {
        categoryParams.branchId = selectedBranch.id
      }
  ...
  }, [searchText, selectedBranch?.id, statusFilter, serializedFilter, warrantyFilter, categoryFilter, unitFilter, page])
