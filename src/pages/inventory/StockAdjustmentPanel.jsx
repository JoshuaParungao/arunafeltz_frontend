  ...
  return h(
    ...
    h(
      ...
      h(
        ...
        {
          className:
            "rounded-2xl border border-[var(--color-border)] px-4 py-2 text-sm font-black text-[var(--color-muted)] transition hover:border-[#7A1F2B] hover:text-[#7A1F2B] disabled:cursor-not-allowed disabled:opacity-60",
          disabled: isSaving,
          onClick: onClose,
          type: "button",
        },
    ...
    message
      ? h(
          ...
          {
            className:
              "mt-4 rounded-2xl bg-[var(--color-soft)] px-4 py-3 text-sm font-bold text-[var(--color-text-strong)]",
          },
          message
        )
      : null,
    ...
    h(
      ...
      h(
        ...
        {
          className:
            "rounded-2xl border border-[var(--color-border)] px-5 py-3 text-sm font-black text-[var(--color-muted)] transition hover:border-[#7A1F2B] hover:text-[#7A1F2B] disabled:cursor-not-allowed disabled:opacity-60",
          disabled: isSaving,
          onClick: onClose,
          type: "button",
        },
      ...
      h(
        ...
        {
          className:
            "rounded-2xl bg-[#7A1F2B] px-5 py-3 text-sm font-black text-white transition hover:bg-[#641824] disabled:cursor-not-allowed disabled:opacity-60",
          disabled: isSaving,
          onClick: onSave,
          type: "button",
        },
