  ...
  return (
    <div className="space-y-5">
      ...
      <section className="rounded-3xl border border-[var(--color-border)] bg-white shadow-card">
        {adjustItem ? (
          <
StockAdjustmentPanel item={adjustItem} batches={adjustBatches} onClose={closeAdjustModal} /
>
        ) : null}
        ) : null}
        {isLoading ? (
                  ...
                  {items.map((item) => (
                    <tr key={item.id} className="align-top transition hover:bg-[var(--color-soft)]">
                      ...
                      <td className="whitespace-nowrap px-4 py-4 text-[var(--color-muted)]">
                        ...
                        <td className="px-5 py-4">                           <div className="flex flex-wrap gap-2">                             {canAdjustStock ? (                               <button                                 className="inline-flex items-center justify-center rounded-2xl border border-[#7A1F2B] bg-white px-4 py-2 text-xs font-black text-[#7A1F2B] transition hover:bg-[#F4F1EC]"                                 onClick={() => openAdjustModal(item)}                                 type="button"                               >                                 Adjust stock                               </button>                             ) : null}                           </div>                         </td>
                    </tr>
                  ))}
                </tbody>
              </table>
