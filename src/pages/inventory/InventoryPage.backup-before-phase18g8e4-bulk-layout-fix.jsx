...
export default function InventoryPage({ selectedBranch }) {
  ...
  const submitBulkStockRequest = async () => {
    ...
    try {
      ...
      setRequestMessage("Bulk stock request sent successfully.")
      setBulkRequestItems([])
      setBulkSearchText("")
          ...
          <div className="flex max-h-[90vh] w-full max-w-5xl flex-col rounded-3xl border border-[var(--color-border)] bg-white p-5 shadow-xl">
            ...
            <div className="mt-5 grid min-h-0 gap-4 lg:grid-cols-[1.2fr_0.8fr]">
              ...
              <section className="rounded-3xl border border-[var(--color-border)] p-4">
                ...
                <button
                  className="mt-3 w-full rounded-2xl bg-[var(--color-accent)] px-5 py-3 text-sm font-black text-white transition hover:bg-[var(--color-accent-hover)] disabled:cursor-not-allowed disabled:opacity-50"
                ...
                {requestMessage ? (
                  <p className="mt-3 rounded-2xl bg-[var(--color-soft)] px-4 py-3 text-sm font-bold text-[var(--color-text-strong)]">
                    {requestMessage}
                  </p>
                ) : null}
                ...
                <div className="sticky bottom-0 mt-5 flex flex-col gap-3 border-t border-[var(--color-border)] bg-white pt-4">
                  {requestMessage ? (
                  ...
                  <p className="text-xs font-semibold text-[var(--color-muted)]">
                    This will send one request only. Stock will not move yet.
                  </p>
                </div>
              </section>
            </div>
