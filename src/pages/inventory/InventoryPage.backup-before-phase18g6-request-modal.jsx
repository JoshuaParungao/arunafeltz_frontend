                    ...
                    <tr key={item.id} className="align-top transition hover:bg-[var(--color-soft)]">
                      ...
                      <td className="whitespace-nowrap px-4 py-4">
                        {canRequestFromViewedBranch ? (
                          <button
                            className="inline-flex items-center justify-center rounded-2xl bg-[var(--color-accent)] px-4 py-2 text-xs font-bold text-white transition hover:bg-[var(--color-accent-hover)] disabled:cursor-not-allowed disabled:opacity-50"
