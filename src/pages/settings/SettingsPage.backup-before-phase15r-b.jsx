...
function ReceiptBusinessNameForm({ setting, onSaved }) {
  ...
  return (
    <Card className="border-[var(--color-maroon)] ring-2 ring-[var(--color-maroon-soft)]">
      <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
        <div className="min-w-0">
          <Badge tone="maroon">Editable</Badge>
      ...
      <form className="mt-5 space-y-4" onSubmit={handleSave}>
        <label className="block">
          ...
          <input
            className="mt-2 h-12 w-full rounded-2xl border border-[var(--color-border)] bg-white px-4 text-sm outline-none transition focus:border-[var(--color-maroon)]"
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          <button
            ...
            type="submit"
          >
            {isSaving ? "Saving..." : "Save Business Name"}
          </button>
      ...
      <section className="rounded-3xl border border-[var(--color-border)] bg-[var(--color-sidebar)] p-5 text-white shadow-card">
        <div className="grid gap-4 xl:grid-cols-[1fr_420px]">
          ...
          <div className="rounded-2xl bg-white/10 p-4 text-sm leading-6 text-white/75">
            Only one setting is editable in this phase. Other editable forms will be added step by step.
          </div>
        </div>
      </section>
