...
function Sidebar({ activePage, onChangePage }) {
  const groups = APP_MODULES.reduce((acc, item) => {
  ...
  return (
    <aside className="hidden w-72 shrink-0 border-r border-[var(--color-border)] bg-[var(--color-sidebar)] px-4 py-5 text-white lg:block">
